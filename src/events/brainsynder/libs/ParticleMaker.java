...
/**
 * This is the new and improved Particle sending class that will be used by all my plugins sooner or later.
 */
public class ParticleMaker {
    ...
    public static enum Particle {
        ...
        private Particle(String name, int id, String version) {
            this.name = name;
            this.id = id;
            allowed = version;
        ...
        public boolean isCompatable() {
            return (version <= ParticleMaker.version);
        }
